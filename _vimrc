...
set fileencoding=cp936                                "设置当前文件编码，可以更改，如：gbk（同cp936）
set fileencodings=ucs-bom,utf-8,gbk,cp936,latin-1     "设置支持打开的文件的编码
set termencoding=cp936                                  "设置输出到终端和控制台的编码方式
...
setlocal foldlevel=100                                 "设置折叠等级为一个教大的数，使初始状态为不折叠
